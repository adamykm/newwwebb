...
export default function ServerPage() {
  ...
  if (serverError) return (
    <div className="loading-screen">
      <p style={{ color: 'var(--red)', marginBottom: 12 }}>Failed to load server</p>
      <p style={{ color: 'var(--text-muted)', fontSize: 13, marginBottom: 16 }}>{serverError}</p>
      <button className="btn btn-primary btn-sm" onClick={loadServer}>Retry</button>
    </div>
  );
